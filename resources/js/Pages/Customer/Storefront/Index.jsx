        ...
        <CustomerLayout hideFooter={false}>
            ...
            <div className="min-h-screen pb-24 text-black dark:text-white" dir="rtl">
                ...
                <section className="max-w-7xl mx-auto px-6 lg:px-12 pt-10 mb-8">
                    <div className="relative rounded-[4rem] overflow-hidden bg-gradient-to-br from-red-500/5 to-amber-500/5 dark:from-[#0d0d10] dark:to-[#16161a] border-2 border-red-500 dark:border-white/5 p-8 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-12 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.05)] dark:shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)]">
                        ...
                        <div className="z-10 text-right flex-1 space-y-6 max-w-2xl animate-in fade-in slide-in-from-right-10 duration-1000">
                            ...
                            <p className="text-sm md:text-lg font-bold text-black/60 dark:text-white/40 leading-relaxed">
                            ...
                            <div className="pt-4 flex flex-wrap gap-4">
                                <a href="#store-listings" className="px-8 py-4 bg-red-500 hover:bg-red-600 dark:bg-amber-400 dark:hover:bg-amber-500 text-white dark:text-black font-black text-xs uppercase tracking-[0.2em] rounded-2xl transition-all shadow-lg shadow-red-500/20 dark:shadow-amber-400/15 active:scale-95">
                                    تصفح المنتجات الآن
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="z-10 w-full lg:w-80 bg-white/40 dark:bg-white/[0.02] backdrop-blur-3xl p-8 rounded-[3rem] border-2 border-red-500 dark:border-white/5 shadow-xl flex flex-col items-center text-center space-y-6">
                            ...
                            <div>
                                <h3 className="text-xl font-black text-black dark:text-white">كتالوج المنتجات 2026</h3>
                                <p className="text-[11px] font-bold text-black/40 dark:text-white/20 uppercase mt-1 tracking-widest">تحديث الربع السنوي الأول</p>
                            </div>
                            <button onClick={() => showToast("سيتم تحميل الكتالوج الرقمي قريباً 📄")} className="w-full py-3 bg-black dark:bg-white text-white dark:text-black hover:bg-black/80 dark:hover:bg-white/80 font-black text-[10px] uppercase tracking-[0.2em] rounded-xl transition-all shadow-md">
                ...
                <section className="max-w-7xl mx-auto px-6 lg:px-12 mb-8" dir="rtl">
                    ...
                    <div className="relative overflow-hidden rounded-[2.5rem] bg-white/50 dark:bg-white/[0.02] border-2 border-red-500 dark:border-white/5 p-6 backdrop-blur-3xl">
                        <div className="flex flex-wrap justify-center gap-4">
                            ...
                            <button
                                ...
                                className={`flex-shrink-0 w-24 h-12 flex items-center justify-center rounded-2xl border text-xs font-black tracking-widest transition-all duration-300 ${selectedBrand === 'all'
                                        ? 'bg-red-500 dark:bg-amber-400 text-white dark:text-black border-red-500 dark:border-amber-400 shadow-md shadow-red-500/25 dark:shadow-amber-400/20 scale-105'
                                        : 'bg-black/[0.03] dark:bg-white/[0.03] border-red-500/10 dark:border-white/5 hover:border-red-500/40 dark:hover:border-white/10 text-black/60 dark:text-white/40'
                                    }`}
                            >
                                الكل
                            </button>
                            {BRANDS.map((brand, i) => (
                                <button
                                    ...
                                    className={`flex-shrink-0 w-24 h-12 flex items-center justify-center rounded-2xl border p-2 transition-all duration-300 group ${selectedBrand === brand.name
                                            ? 'bg-red-500/10 dark:bg-amber-400/20 border-red-500 dark:border-amber-400 ring-2 ring-red-500/20 dark:ring-amber-400/35 scale-105'
                                            : 'bg-black/[0.03] dark:bg-white/[0.03] border-red-500/10 dark:border-white/5 hover:border-red-500/40 dark:hover:border-white/10'
                                        }`}
                                >
                                    <img
                                        src={brand.src}
                ...
                <section id="store-listings" className="max-w-7xl mx-auto px-6 lg:px-12 mb-8">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-6 bg-white/60 dark:bg-white/[0.02] backdrop-blur-3xl p-6 rounded-[3rem] border-2 border-red-500 dark:border-white/5 shadow-sm">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
                            ...
                            <div className="relative w-full sm:w-48">
                                <select
                                    ...
                                    className="w-full bg-black/[0.03] dark:bg-white/[0.03] border-2 border-red-500 dark:border-white/10 rounded-2xl px-6 py-3.5 text-xs font-bold text-black/70 dark:text-white/60 focus:outline-none focus:border-red-500 dark:focus:border-amber-400 cursor-pointer appearance-none text-right"
                                >
                                ...
                                <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-black/40 dark:text-white/20 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M19 9l-7 7-7-7" /></svg>
                            </div>
                            ...
                            <div className="relative w-full sm:w-72">
                                <input
                                    ...
                                    className="w-full bg-black/[0.03] dark:bg-white/[0.03] border-2 border-red-500 dark:border-white/10 rounded-2xl px-12 py-3.5 text-xs text-black dark:text-white placeholder-black/40 dark:placeholder-white/20 focus:outline-none focus:border-red-500 dark:focus:border-amber-400 text-right font-bold transition-all"
                                />
                                <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-black/40 dark:text-white/20" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="max-w-7xl mx-auto px-6 lg:px-12 mb-40">
                    {sortedFiltered.length === 0 ? (
                        <div className="text-center py-40 bg-white/50 dark:bg-white/[0.01] rounded-[5rem] border-2 border-red-500 dark:border-white/5 backdrop-blur-xl">
                            <h3 className="text-2xl font-black text-black/40 dark:text-white/20">لا توجد نتائج مطابقة لتحديدك حالياً</h3>
                        </div>
                    ) : (
    ...
    return (
        <button
            ...
            className={`px-5 py-2 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-300 border ${active
                ? 'bg-red-500 dark:bg-amber-400 text-white dark:text-black border-red-500 dark:border-amber-400 shadow-md shadow-red-500/15 dark:shadow-amber-400/20'
                : 'bg-black/[0.03] dark:bg-white/[0.03] text-black/60 dark:text-white/40 border-red-500/10 dark:border-white/5 hover:text-black dark:hover:text-white hover:border-red-500 dark:hover:border-white/10'
                }`}
        >
            {label}
        </button>
...
function ProductCard({ product, quantity, inCartQuantity, onStep, onQuantityChange, onBlur, onAddToCart }) {
    return (
        <div className="group bg-white/80 dark:bg-[#16161a]/60 backdrop-blur-3xl rounded-[3rem] border-2 border-red-500 dark:border-white/5 p-5 transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl hover:border-red-600 dark:hover:border-amber-400/25 relative overflow-hidden flex flex-col justify-between">

            {/* Selection Glow / Shadow */}
            {inCartQuantity > 0 && <div className="absolute inset-0 bg-red-500/[0.01] dark:bg-amber-400/[0.01] border border-red-500/25 dark:border-amber-400/20 rounded-[3rem] pointer-events-none" />}

            {/* In Cart Indicator */}
            {inCartQuantity > 0 && (
                <div className="absolute top-4 left-6 z-20 w-8 h-8 bg-red-500 dark:bg-amber-400 text-white dark:text-black rounded-xl flex items-center justify-center font-black text-xs shadow-lg">
                    {inCartQuantity}
                </div>
            )}
            ...
            <div>
                ...
                <div className="space-y-3">
                    <Link href={route('customer.storefront.show', product.id)}>
                        <h3 className="text-sm md:text-lg font-black text-black dark:text-white group-hover:text-red-500 dark:group-hover:text-amber-400 transition-colors line-clamp-2 h-12 leading-tight">
                            {product.name}
                        </h3>
                    </Link>
                    <span className="inline-block text-[8px] font-black text-red-500/60 dark:text-white/20 uppercase tracking-widest">{product.category_name || 'صنف غذائي'}</span>
                </div>
            </div>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <div className="text-xl md:text-2xl font-black text-black dark:text-white">
                            ...
                            <span className="text-[10px] text-black/50 dark:text-white/20 uppercase tracking-widest mr-1">{product.default_currency_symbol}</span>
                        </div>
                        <div className="text-[9px] font-bold text-black/40 dark:text-white/20 uppercase tracking-widest mt-0.5">{product.default_unit_name}</div>
                    </div>

                    <div className="flex items-center bg-black/[0.03] dark:bg-white/5 rounded-2xl p-1.5 border border-red-500/20 dark:border-white/10 shadow-inner">
                        <button onClick={() => onStep(1)} className="w-8 h-8 flex items-center justify-center text-black/60 dark:text-white/40 hover:text-red-500 dark:hover:text-amber-400 font-bold transition-all">+</button>
                        <input type="text" value={quantity} onChange={(e) => onQuantityChange(e.target.value)} onBlur={onBlur} className="w-10 bg-transparent text-center font-black text-sm text-black dark:text-white border-none focus:ring-0 p-0" />
                        <button onClick={() => onStep(-1)} disabled={quantity <= 1} className="w-8 h-8 flex items-center justify-center text-black/60 dark:text-white/40 hover:text-red-500 dark:hover:text-amber-400 font-bold transition-all disabled:opacity-10">-</button>
                    </div>
                </div>
