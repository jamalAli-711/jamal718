                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="card-editorial overflow-hidden">
                        <div className="p-8 border-b border-gray-50 flex justify-between items-end">
                            <div>
                                <span className="text-[10px] font-black text-[#0058be] uppercase tracking-[0.3em] mb-1 block">Order history</span>
                        ...
                        {orders && orders.length > 0 ? (
                                            ...
                                            <tr key={order.id} className="hover:bg-gray-50/80 transition-colors group">
                                                ...
                                                <td className="px-8 py-6">
                                                    <div className="flex flex-col">
                                                        <span className="font-black text-[#0058be] text-xl">{Number(order.final_amount).toLocaleString()}</span>
                                                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Yemeni Rial</span>
                                                    </div>
                                                </td>
                                                <td className="px-8 py-6 text-center">
                            ...
                            <div className="p-24 text-center">
                                ...
                                <h3 className="text-3xl font-black text-[#031633] mb-4">No orders yet</h3>
